            ...
            <div class="product-right">
                    ...
                    <div class="option-box">
                        ...
                        <div class="option-list">
                            <% for (int i = 0; i < listVariants.size(); i++) {
                                    String storageVal = listVariants.get(i).getStorage();
                                    String colorVal = listVariants.get(i).getColor();
                                    String inputId = "storage_" + i;
                            %>
                            <input type="radio" id="<%= inputId%>" name="storage"
                                   value="<%= storageVal%>" <%= (i == 0) ? "checked" : ""%>
                    ...
                    <div class="option-box">
                        ...
                        <div class="color-list">
                            ...
                            <input type="radio" id="<%= colorId%>" name="color"
                                   value="<%= colorVal%>" <%= (i == 0) ? "checked" : ""%>
                                   onchange="this.form.submit()">

                            <label for="<%= colorId%>" class="color-label"
                                   style="background-color:<%= colorVal%>;"></label>
                            <% } %>
                        </div>
                    </div>
                ...
                <form action="product">
                    ...
                    <div class="price-box">
                        <p>Price</p>
                        <h2 id="price">
                            <%= String.format("%,.0f", variant.getDiscountPrice())%> VND
                        </h2>
                    </div>
                    ...
                    <div class="option-box">
                        ...
                        <div class="option-list">
                            ...
                            <input type="radio" id="<%= inputId%>" name="storage"
                                   value="<%= storageVal%>"
                                   <%= (variant.getStorage().equals(storageVal)) ? "checked" : ""%>
                                   onchange="this.form.submit()">
                    ...
                    <div class="option-box">
                        ...
                        <div class="color-list">
                            ...
                            <input type="radio" id="<%= colorId%>" name="color"
                                   value="<%= colorVal%>"
                                   <%= (variant.getColor().equals(colorVal)) ? "checked" : ""%>
                                   onchange="this.form.submit()">
