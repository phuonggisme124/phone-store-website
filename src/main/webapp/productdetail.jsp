...
<html>
    ...
    <%
        ...
        if (variants == null || listVariants == null || listVariants.isEmpty()) {

    %>
    <p style="color:red;">Product variant data not found!</p>
    <%            return;
        }
    %>
            ...
            <div class="product-right">
                ...
                <div class="option-box">
                    ...
                    <div class="option-list">
                        ...
                        <a href="product?action=selectStorage&pID=<%= variants.getProductID()%>&color=<%= variants.getColor()%>&storage=<%= v%>" for="" class="option-label">
                            <%= v%>
                        </a>
                        <%
                ...
                <div class="option-box">
                    ...
                    <div class="color-list">
                        ...
                        <a href="product?action=selectStorage&pID=<%= variants.getProductID()%>&color=<%= colorV%>&storage=<%= variants.getStorage() %>"   for="<%= colorId%>" class="color-label"
