...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .payment-option.selected { border-color: #72AEC8; box-shadow: 0 0 0 2px rgba(114, 174, 200, 0.4); }
            .term-column.selected { background-color: #eaf4f7; border-color: #72AEC8; }
            .term-column.selected .term-button { background-color: #72AEC8; color: white; cursor: default; }
            .term-column.selected .term-header { color: #72AEC8; }
            ...
            .term-button { border-color: #72AEC8; color: #72AEC8; }
        </style>
    </head>
