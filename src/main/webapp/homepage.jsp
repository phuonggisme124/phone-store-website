...
<!-- Video Background -->
    <section id="billboard">
        ...
        <div class="overlay-content">
            <h2>NEW ARRIVAL</h2>
            <h1>iPhone 17</h1>
            <a href="product?action=category&cID=1" class="btn-discover">Discover Now</a>
        </div>
    </section>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Luôn search theo "All Products" vì ?ây là homepage
    ...
    searchInput.addEventListener('keyup', function () {
        ...
        if (query.length > 0) {
            allSuggestionItems.forEach(item => {
                ...
                // Ki?m tra n?u query có trong tên s?n ph?m ho?c text
            ...
            if (hasResults) {
                ...
                // Hi?n th? thông báo không tìm th?y
