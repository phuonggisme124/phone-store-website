                ...
                <div class="swiper product-swiper">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="product-card text-center position-relative">
                                <div class="image-holder">
                                    <img src="images/iphone11.jpg" alt="Iphone 11" class="img-fluid rounded-3">
                                </div>
                                <div class="card-detail pt-3">
                                    <h3 class="card-title text-uppercase">
                                        <a href="#">iPhone 11</a>
                        ...
                        <div class="swiper-slide">
                            <div class="product-card text-center position-relative">
                                <div class="image-holder">
                                    <img src="images/iphone8.jpg" alt="Iphone 8" class="img-fluid rounded-3">
                                </div>
                                <div class="card-detail pt-3">
                                    <h3 class="card-title text-uppercase">
                                        <a href="#">iPhone 8</a>
                        ...
                        <div class="swiper-slide">
                            <div class="product-card text-center position-relative">
                                <div class="image-holder">
                                    <img src="images/iphone13.jpg" alt="Iphone 13" class="img-fluid rounded-3">
                                </div>
                                <div class="card-detail pt-3">
                                    <h3 class="card-title text-uppercase">
                                        <a href="#">iPhone 13</a>
                        ...
                        <div class="swiper-slide">
                            <div class="product-card text-center position-relative">
                                <div class="image-holder">
                                    <img src="images/iphone12.jpg" alt="Iphone 12" class="img-fluid rounded-3">
                                </div>
                                <div class="card-detail pt-3">
                                    <h3 class="card-title text-uppercase">
                                        <a href="#">iPhone 12</a>
