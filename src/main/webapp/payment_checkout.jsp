...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .bg-theme { background-color: #72AEC8; }
            .bg-theme-light { background-color: #eaf4f7; }
            .hover\:bg-theme-dark:hover { background-color: #619db5; }
            .term-button {
                border-color: #72AEC8;
                color: #72AEC8;
            }
    ...
    <body class="bg-gray-100">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                // SỬA LỖI Ở ĐÂY: Cập nhật hàm này để xử lý class của icon thay vì src của ảnh
                ...
                confirmPaymentBtn.addEventListener('click', () => {
                    ...
                    if (selectedOption && selectedOption.dataset.value === 'COD') {
                        // SỬA LỖI Ở ĐÂY: Truyền `data-fa-icon-class` vào hàm
                ...
                confirmInstallmentBtn.addEventListener('click', () => {
                    if (selectedInstallmentTerm) {
                        ...
                        // SỬA LỖI Ở ĐÂY: Lấy icon class từ `data-fa-icon-class`
