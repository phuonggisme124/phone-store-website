    ...
    <body class="bg-gray-100 text-gray-900 font-sans">
                                    ...
                                    if (variantsList_search != null && !productNameMap_search.isEmpty()) {
                                        for (Variants v : variantsList_search) {
                                            ...
                                            if (productName != null && categoryID != null) {
                                                String image = (v.getImageUrl() != null) ? v.getImageUrl().split("#")[0] : ""; // Lấy ảnh đầu tiên
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                searchInput.addEventListener('keyup', function () {
                    ...
                    // Ẩn thông báo "No products found" trước khi tìm kiếm mới
        ...
        <div class="container max-w-7xl mx-auto p-4 sm:p-6">
            ...
            <%
                ...
                // === THAY ĐỔI 1: Khởi tạo biến cờ để kiểm tra chế độ lọc khuyến mãi ===
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                <%
                    ...
                    // === THAY ĐỔI 2: Logic lọc sản phẩm khuyến mãi ===
                    // Chỉ thực hiện lọc nếu người dùng ĐANG ở chế độ "Khuyến mãi HOT"
                        ...
                        if (promotionsList != null && !promotionsList.isEmpty() && listVariant != null) {
                            for (Variants v : listVariant) {
                                for (Promotions promotion : promotionsList) {
                                    // Kiểm tra xem ProductID có trong ds khuyến mãi VÀ khuyến mãi đó đang "active" không
                                    if (v.getProductID() == promotion.getProductID() && "active".equalsIgnoreCase(promotion.getStatus())) {
                                        listVariantFiltered.add(v);
                                        break; // Đã tìm thấy 1 khuyến mãi active cho SP này, qua SP tiếp theo
                                    }
                                }
                            }
                        }
                        // Ghi đè danh sách gốc bằng danh sách đã lọc
                    ...
                    if (listVariant != null && !listVariant.isEmpty() && listProduct != null) {
                        for (Variants v : listVariant) {
                            ...
                            // Lấy thông tin khuyến mãi CỤ THỂ của sản phẩm này để hiển thị tag
                ...
                <div class="bg-white rounded-2xl shadow-md overflow-hidden flex flex-col transition duration-300 hover:scale-[1.02] hover:shadow-lg">
                    <div class="relative">
                        ...
                        <%-- Hiển thị tag discount nếu có và đang active --%>
                    ...
                    <div class="p-4 flex flex-col flex-grow">
                        ...
                        <div class="mb-2">
                            ...
                            <%-- Chỉ hiển thị giá gốc nếu giá gốc > giá giảm giá --%>
