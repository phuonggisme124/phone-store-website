        ...
        <script>
            ...
            <% if (orders != null && !orders.isEmpty()) {
                    for (int i = 0; i < orders.size(); i++) {
                        ...
                        // Lấy thông tin customer từ bảng Customers
                        String customerName = o.getReceiverName() != null ? o.getReceiverName() : "";
                        String phone = o.getReceiverPhone() != null ? o.getReceiverPhone() : "";

                        if (o.getBuyer() != null) {
                            if (o.getBuyer().getFullName() != null) {
                                customerName = o.getBuyer().getFullName();
                            }
                            if (o.getBuyer().getPhone() != null) {
            ...
            orderID: <%= o.getOrderID()%>,
                    ...
                    phone: "<%= phone%>",
                    address: "<%= o.getShippingAddress() != null ? o.getShippingAddress() : ""%>",
                    totalAmount: "<%= currencyFormatter.format(o.getTotalAmount())%>",
                    orderDate: "<%= o.getOrderDate() != null ? o.getOrderDate() : ""%>",
                    status: "<%= status != null ? status : ""%>",
                    statusBadge: '<span class="status-badge <%= statusClass%>"><i class="bi <%= statusIcon%>"></i> <%= status != null ? status : ""%></span>',
            <% if (o.getShippers() != null) {%>
            shipperName: "<%= o.getShippers().getFullName() != null ? o.getShippers().getFullName() : ""%>",
                    shipperPhone: "<%= o.getShippers().getPhone() != null ? o.getShippers().getPhone() : ""%>",
            <% }%>
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        <% for (Order o : orders) {
                                                ...
                                                // Hiển thị tên khách hàng từ ReceiverName hoặc Buyer
                                                String displayName = o.getReceiverName();
                                                String displayPhone = o.getReceiverPhone();

                                                if (o.getBuyer() != null) {
                                                    if (o.getBuyer().getFullName() != null) {
                                                        displayName = o.getBuyer().getFullName();
                                                    }
                                                    if (o.getBuyer().getPhone() != null) {
                                                        displayPhone = o.getBuyer().getPhone();
                                                    }
                                                }
                                        %>
                                        <tr onclick="viewOrderDetail(<%= o.getOrderID()%>, <%= o.getIsInstalment() != null && o.getIsInstalment()%>)">
                                            ...
                                            <td><strong><%= displayName != null ? displayName : "N/A"%></strong></td>
                                            <td><%= displayPhone != null ? displayPhone : "N/A"%></td>
                                            <td><%= o.getShippingAddress() != null ? o.getShippingAddress() : "N/A"%></td>
                                            <td><%= currencyFormatter.format(o.getTotalAmount())%></td>
                                            <td><%= o.getOrderDate() != null ? o.getOrderDate() : "N/A"%></td>
                                            <td>
                                            ...
                                            <td onclick="event.stopPropagation();">
                                                ...
                                                <div class="shipper-info d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="fw-bold"><%= shipper.getFullName()%></div>
                                                        <small class="text-muted"><%= shipper.getPhone()%></small>
                                                    </div>
                                                </div>
                                                <% } else { %>                                    
                            ...
                            <div class="modal-body">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <button class="btn btn-sm btn-primary" onclick="submitAssignForm(<%= s.getStaffID()%>)">
