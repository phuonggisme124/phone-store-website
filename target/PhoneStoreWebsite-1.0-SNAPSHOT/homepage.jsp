...
<html>
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  ...
                  <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                    ...
                    <span class="item-price text-primary">$450</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="swiper product-watch-swiper">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  ...
                  <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                    ...
                    <span class="item-price text-primary">$660</span>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="images/product-item11.jpg" alt="product-item" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="images/product-item12.jpg" alt="product-item" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
                  ...
                  <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                    ...
                    <span class="item-price text-primary">$550</span>
                  </div>
                </div>
              </div>
            </div>
    ...
    <section id="yearly-sale" class="bg-light-blue padding-large">
      <div class="container">
        <div class="row d-flex justify-content-center">
          <div class="col-md-9">
            <div class="section-header text-center mb-4">
              <h2 class="display-7 text-dark text-uppercase">Annual Sale 2023</h2>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="banner-image bg-image" style="background-image: url(images/single-image1.jpg)">
              <div class="banner-content p-5">
                <h2 class="display-4 text-uppercase text-dark">Watches</h2>
          ...
          <div class="col-md-6">
            <div class="banner-image bg-image" style="background-image: url(images/single-image2.jpg)">
              <div class="banner-content p-5">
                <h2 class="display-4 text-uppercase text-dark">Gadgets</h2>
                <div class="btn-container">
                  <a href="shop.html" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Shop Product</a>
                </div>
              </div>
        ...
        <div class="row">
          ...
          <div class="post-grid d-flex flex-wrap justify-content-between">
            <div class="col-lg-4 col-sm-12">
              <div class="card border-0 sm-mb-3">
                <div class="card-image">
                  <img src="images/post-item1.jpg" alt="" class="img-fluid">
                </div>
                <div class="card-body text-uppercase">
                  <div class="meta-date">
                    <small>20 <span class="sm-block">Feb</span></small>
                  </div>
                  <h3 class="card-title mt-3 mb-3">
                    <a href="#">
                      Get some comfortable headphones
                    </a>
                  </h3>
                  <p>
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-0 sm-mb-3">
                ...
                <div class="card-body text-uppercase">
                  <div class="meta-date">
                    <small>22 <span class="sm-block">Feb</span></small>
                  </div>
                  <h3 class="card-title mt-3 mb-3">
                    <a href="#">
                      Gadgets, what every teenager wants
                    </a>
                  </h3>
                  <p>
                    Nulla vitae elit libero, a pharetra augue.
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-0 sm-mb-3">
                ...
                <div class="card-body text-uppercase">
                  <div class="meta-date">
                    <small>25 <span class="sm-block">Feb</span></small>
                  </div>
                  <h3 class="card-title mt-3 mb-3">
                    <a href="#">
                    ...
                    <div class="row">
                      <div class="col-md-8 offset-md-2">
                        <div class="review-header text-center">
                          <h2 class="display-7 text-dark pb-4">Our Customers Says</h2>
                          <img src="images/quote.png" alt="quote">
                        </div>
                        <blockquote class="text-center">
                          <p>?Tempus oncu enim pellen tesque este pretium in neque, elit morbi sagittis a, nisl cras sed purus vitae, arcu pellentesque ut.?</p>
                          <div class="author-detail">
                            <h4 class="text-dark">Shalini Shah</h4>
                            <span class="sm-text">CEO of NextPro</span>
                          </div>
                        </blockquote>
                      </div>
                    </div>
                  ...
                  <div class="container">
                    <div class="row">
                      <div class="col-md-8 offset-md-2">
                        ...
                        <blockquote class="text-center">
                          <p>?Amet id enim vel tempus egestas.
                            Sollicitudin morbi porttitor  pellentesque in neque, elit morbi sagittis a, nisl cras sed purus vitae, arcu pellentesque ut.?</p>
                          <div class="author-detail">
                            <h4 class="text-dark">Eliza Hess</h4>
                            <span class="sm-text">Designer at Fictive</span>
                          </div>
                        </blockquote>
                      </div>
                    </div>
    ...
    <section id="flash-sale" class="padding-large">
      <div class="container">
        <div class="row d-flex flex-wrap align-items-center">
          <div class="col-md-6">
            <div class="banner-image">
              <img src="images/single-image3.png" alt="flash-sale">
            </div>
          </div>
          <div class="col-md-6">
            <div class="content-caption">
              <div class="section-header">
                <h2 class="display-7 text-dark text-uppercase">Flash sale</h2>
              </div>
              <h3 class="item-price text-dark">$890</h3>
              <div class="description">
                <p>Dictumst aliquet cras sagittis sed purus, arcu elit
                  lectus sit.
                  In eu arcu egestas lorem purus iaculis
                  nunc feugiat
                  vitae, eget tellus sed.
                  Tellus et
                  condimentum at
                  eros
                  posuere
              ...
              <div class="timer d-flex mt-3">
                <div class="countdown-box pe-4">
                  <div class="countdown-inner">
                    <h3 id="days" class="days text-dark"></h3>
                    <span class="sm-text">Days</span>
                  </div>
                </div>
                <div class="countdown-box pe-4">
                  <div class="countdown-inner">
                    <h3 id="hours" class="hours text-dark"></h3>
                    <span class="sm-text">Hours</span>
                  </div>
                </div>
                <div class="countdown-box pe-4">
                  <div class="countdown-inner">
                    <h3 id="minutes" class="minutes text-dark"></h3>
                    <span class="sm-text">Minutes</span>
                  </div>
                </div>
                <div class="countdown-box pe-4">
                  <div class="countdown-inner">
                    <h3 id="seconds" class="seconds text-dark"></h3>
                    <span class="sm-text">Seconds</span>
                  </div>
                </div>
              </div>
              <div class="btn-left mt-3">
                <a href="#" class="btn btn-medium btn-black">Shop Product</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="subscribe-content bg-dark d-flex flex-wrap justify-content-center align-items-center padding-medium">
            <div class="col-md-6 col-sm-12">
              <div class="display-header pe-3">
                <h2 class="display-7 text-white text-uppercase">Subscribe Us Now</h2>
              ...
              <div class="col-lg-3 col-sm-6 pb-3">
                <div class="footer-menu contact-item">
                  ...
                  <p>Do you have any queries or suggestions? 
                    <a href="mailto:">ministore@gmail.com</a>
                  </p>
                  <p>If you need support, just give us a call. 
                    <a href="tel:0110232777">0110232777</a>
                  </p>
                </div>
              </div>
            </div>
